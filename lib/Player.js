...
function Player(name = '') {
    ...
    */
    ...
    Player.prototype.addPotion = function(potion) {
        this.inventory.push(potion);// a push is an array that adds an item to the end of an array
    };

    Player.prototype.usePotion = function (index) {
        const potion = this.getInventory().splice(index,1)[0];//splice method removes items frm an array and returns the removed item(s) as a new array
